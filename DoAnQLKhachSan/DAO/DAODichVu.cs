...
namespace DAO
{
    public class DAODichVu
    {
        ...
        {
            dsDichVu = db.LayDanhSach("select DichVu.ID,TenLoaiDV,TenDV,MoTa,HinhAnh,GiaTien,SLTon,DVT,GhiChu,dbo.DV_HieuLuc(DichVu.HieuLuc) as HieuLuc from DichVu,LoaiDV where DichVu.ID_LoaiDV=LoaiDV.ID and DichVu.HieuLuc=1 and (TenLoaiDV like N'%" + sTimKiem + "%' or TenDV like N'%" + sTimKiem + "%')");
